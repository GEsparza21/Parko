            ...
            <div class="col-md-6">
                <div class="text-center">
                    ...
                    <form method="POST" action="">
                     <div class="mb-3">
    <h2>Nombre:</h2>
    <input type="text" id="Nombre" name="nombre" class="form-control" value="<?php echo $nombre; ?>" <?php if(!empty($nombre)) { echo 'disabled'; } ?>>
</div>
<div class="mb-3">
    <h2>Apellido Paterno:</h2>
    <input type="text" id="ApellidoPa" name="apellidoPaterno" class="form-control" value="<?php echo $apellidoPaterno; ?>" <?php if(!empty($apellidoPaterno)) { echo 'disabled'; } ?>>
</div>
<div class="mb-3">
    <h2>Apellido Materno:</h2>
    <input type="text" id="ApellidoMa" name="apellidoMaterno" class="form-control" value="<?php echo $apellidoMaterno; ?>" <?php if(!empty($apellidoMaterno)) { echo 'disabled'; } ?>>
</div>
<div class="mb-3">
    <h2>Placas:</h2>
    <input type="text" id="Piso" name="piso" class="form-control" value="<?php echo $piso; ?>" <?php if(!empty($piso)) { echo 'disabled'; } ?>>
</div>
<div class="mb-3">
    <h2>Número de apartamento:</h2>
    <input type="number" id="Apartamento" name="Apartamento" class="form-control" value="<?php echo $numeroApartamento; ?>" disabled>    
</div>
<div class="mb-3">
    <h2>Teléfono:</h2>
    <input type="number" id="Telefono" name="telefono" class="form-control" value="<?php echo $telefono; ?>" <?php if(!empty($telefono)) { echo 'disabled'; } ?>>
</div>
<div class="mb-3">
    <h2>Número de cajón:</h2>
    <input type="number" id="Cajon" name="cajonEstacionamiento" class="form-control" value="<?php echo $cajonEstacionamiento; ?>" disabled>
</div>
